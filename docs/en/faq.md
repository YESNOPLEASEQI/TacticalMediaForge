...
|--------------|---------|----------|-------|
| Text-only<br/>(e.g., `simple.html`) | 鉂?Not needed | Quotes, announcements, reading prompts | 鈿♀殹鈿?Very fast |
| AI Images<br/>(e.g., `default.html`) | 鉁?Required | Rich visual content | 鈿?Standard |
...
- **Recommended**: Qianwen + Local ComfyUI 鈮?$0.01-0.05/video
...
Have other questions? Check [Troubleshooting](troubleshooting.md) or submit an [Issue](https://github.com/YESNOPLEASEQI/MilitaryVideoGenAgent/issues).

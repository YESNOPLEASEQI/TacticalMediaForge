...
- `default_workflow`: Default video generation workflow
  - `selfhost/video_ltx2_3_t2v.json`: Default local LTX 2.3 text-to-video workflow (requires the LTX 2.3 models listed in the workflow)
  - `runninghub/video_wan2.1_fusionx.json`: Cloud workflow (requires a RunningHub API key)
  - `selfhost/video_wan2.1_fusionx.json`: Legacy local WAN workflow

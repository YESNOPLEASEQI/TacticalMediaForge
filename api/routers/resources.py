...
from military_video_gen.utils.os_util import get_data_path, get_root_path
from military_video_gen.utils.template_util import get_all_templates_with_info

router = APIRouter(prefix="/resources", tags=["Resources"])


@router.get("/workflows/tts", response_model=WorkflowListResponse)
async def list_tts_workflows(military_video_gen: MilitaryVideoGenDep):
    """
    ...
    try:
        ...
        all_workflows = military_video_gen.tts.list_workflows()
        ...
        raise internal_server_error("List TTS workflows error", e)


@router.get("/workflows/media", response_model=WorkflowListResponse)
async def list_media_workflows(military_video_gen: MilitaryVideoGenDep):
    """
    ...
    try:
        ...
        all_workflows = military_video_gen.media.list_workflows()
        ...
        raise internal_server_error("List media workflows error", e)


# Keep old endpoint for backward compatibility
@router.get("/workflows/image", response_model=WorkflowListResponse)
async def list_image_workflows(military_video_gen: MilitaryVideoGenDep):
    """
    ...
    try:
        ...
        raise internal_server_error("List image workflows error", e)
    ...
    try:
        ...
        for t in all_templates:
            templates.append(TemplateInfo(
                ...
                path=f"templates/{t.template_path}",
                key=t.template_path
            ))
        ...
        raise internal_server_error("List templates error", e)
...
async def list_bgm():
    ...
    try:
        ...
        raise internal_server_error("List BGM error", e)

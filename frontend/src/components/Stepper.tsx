...
export default function Stepper({
  ...
  return (
    <div
      className={`flex min-h-full flex-1 flex-col items-center justify-center p-4 sm:aspect-[4/3] md:aspect-[2/1] ${className}`}
      {...rest}
    >
      <div
...
function StepConnector({ isComplete }: StepConnectorProps) {
  ...
  return (
    <div className="rb-stepper__connector relative mx-2 h-px flex-1 overflow-hidden rounded bg-border">
      <motion.div
        className="rb-stepper__connector-fill absolute left-0 top-0 h-full"

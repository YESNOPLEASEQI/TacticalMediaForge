...
from military_video_gen.models.storyboard import Storyboard, StoryboardConfig, VideoGenerationResult
...
class LinearVideoPipeline(BasePipeline):
    ...
    async def handle_exception(self, ctx: PipelineContext, error: Exception):
        ...
        logger.error(f"Pipeline execution failed: {sanitize_error_message(error)}")

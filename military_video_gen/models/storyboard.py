...
class StoryboardFrame:
    ...
    composed_image_paths: List[str] = field(default_factory=list)  # Timed subtitle card frames
    ...
    audio_duration: float = 0.0                # Narration duration used for subtitle timing
